...
function Start-Timer {
    ...
    while ($endTime -gt (Get-Date)) {
        ...
        Write-Host "$status`n"
        Write-Host "`n`n`n   $currentOperation`n"
        Write-Host "  $progressBar`n`n`n`n`n"
		Show-Divider
...
function Show-TimerOverScreen {
    ...
    Show-Header
    Write-Host "`n`n`n`n`n`n                 Timer Over!`n`n`n`n`n`n"
    Show-Divider
    # Play sound
